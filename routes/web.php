...
Route::middleware('auth')->prefix('admin')->group(function() {
    ...
    Route::put('/users/{user}', [UserController::class, 'update'])->name('users.update')->middleware(CheckIfIsAdmin::class);
    Route::get('/users/{user}/edit', [UserController::class, 'edit'])->name('users.edit')->middleware(CheckIfIsAdmin::class);
